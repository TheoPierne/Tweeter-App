...
$router->addRoute('view', 'view_tweet', '\theop\tweeterapp\tweeterapp\control\TweetController');
...
$router->addRoute('following_tweet', 'view_following_tweet', '\theop\tweeterapp\tweeterapp\control\FollowingTweetController', TweeterAuthentification::ACCESS_LEVEL_USER);
