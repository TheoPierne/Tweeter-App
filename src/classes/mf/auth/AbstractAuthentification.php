...
namespace theop\tweeterapp\mf\auth;

use theop\tweeterapp\mf\exceptions as E;
...
abstract class AbstractAuthentification {
    ...
    public static function checkAccessRight(int $requested): bool{
        ...
        if (isset($_SESSION['user_profile']['access_level'])) {
            return $requested > $_SESSION['user_profile']['access_level'] ? false : true;
        }else{
            return $requested > self::ACCESS_LEVEL_NONE ? false : true;
        }
