...
class RouterTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testSubclass(){
        $this->assertTrue(is_subclass_of('theop\tweeterapp\mf\router\Router', 'theop\tweeterapp\mf\router\AbstractRouter'),
    ...
    public function testAddRoute(){
        ...
        $routes = $this->getPrivateProperty('theop\tweeterapp\mf\router\Router', 'routes')->getValue($r);
        $aliases = $this->getPrivateProperty('\theop\tweeterapp\mf\router\Router', 'aliases')->getValue($r);
    ...
    public function testSetDefaultRoute(){
        ...
        $aliases = $this->getPrivateProperty('theop\tweeterapp\mf\router\Router', 'aliases')->getValue($r);
    ...
    public function testRun(){
     ...
     public function testUrlFor(){
        ...
        $this->assertEquals($r->urlFor($name), $expected,
                           "$expected FEEDBACK : La méthode urlFor doit retourner l'url complète de la route nommée.\nE.g. : urlFor('home') retourne \"/Tweeter/main.php?action=list_tweets\"");
