...
class RouterTest2 extends \PHPUnit\Framework\TestCase {
    ...
    public function testSubclass(){
        $this->assertTrue(is_subclass_of('\theop\tweeterapp\mf\router\Router', '\theop\tweeterapp\mf\router\AbstractRouter'),
    ...
    public function testAddRoute(){
        ...
        $routes = $this->getPrivateProperty('\theop\tweeterapp\mf\router\Router', 'routes')->getValue($r);
